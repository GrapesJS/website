...
const REWARDFUL_QUEUE_SNIPPET = `(function(w,r){w._rwq=r;w[r]=w[r]||function(){(w[r].q=w[r].q||[]).push(arguments)}})(window,'rewardful');`;
  ...
  children: React.ReactNode;
    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <Script id="posthog-loader" strategy="lazyOnload">
          {POSTHOG_SNIPPET}
        </Script>
        <Script id="rewardful-queue" strategy="lazyOnload">
          {REWARDFUL_QUEUE_SNIPPET}
        </Script>
        <Script
          id="rewardful-script"

...
This means the GrapesJS framework will remain open-source and free of charge, with no changes. Our goal at Grapes Studio is to extend its capabilities, not limit them. We see a great opportunity in investing in [GrapesJS Studio](https://app.grapesjs.com/studio), an application built on top of the GrapesJS framework.
